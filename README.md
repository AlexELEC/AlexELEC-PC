...
AlexELEC is a 'Just enough OS' Linux distribution for running Kodi on popular low-cost hardware. AlexELEC is a minor fork of [LibreELEC](https://libreelec.tv), it's built by the community for the community. [AlexELEC website](https://alexelec.tv).

**Issues & Support**

Please report issues via the AlexELEC [Forum](http://forum.alexelec.tv).

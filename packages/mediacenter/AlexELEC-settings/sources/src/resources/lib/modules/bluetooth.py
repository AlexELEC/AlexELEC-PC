    ...
    def adapter_powered(self, adapter, state=1):
        try:
            ...
            if int(self.adapter_info(self.dbusBluezAdapter, 'Powered')) != state:
                ...
                adapter_interface.Set('org.bluez.Adapter1', 'Alias', dbus.String(os.environ.get('HOSTNAME', 'alexelec')))
    ...
    class monitor:
        ...
        def __init__(self, oeMain, parent):
            try:
                ...
                self.btAgentPath = '/AlexELEC/bt_agent'
                self.obAgentPath = '/AlexELEC/ob_agent'
                self.parent = parent
